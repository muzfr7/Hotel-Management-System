...
use Renz\AdminBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('renz_admin_user_index'));
        }
    ...
    private function createCreateForm(User $entity)
    {
        $form = $this->createForm(new UserType(), $entity, array(
            'action' => $this->generateUrl('renz_admin_user_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new UserType(), $entity, array(
            'action' => $this->generateUrl('renz_admin_user_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
        	...
        	$encoder = $this->container->get('security.encoder_factory')->getEncoder($entity);
        	$entity->setPassword($encoder->encodePassword($editForm['password']->getData(), $entity->getSalt()));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('renz_admin_user_delete', array('id' => $id)))
            ->setMethod('DELETE')
