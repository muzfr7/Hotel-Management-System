...
use Renz\AdminBundle\Form\CustomerType;
...
class CustomerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ModelBundle:Customer')->findAll();
     ...
     * @Method("POST")
     * @Template("ModelBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ModelBundle:Customer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ModelBundle:Customer:edit.html.twig")
     */
