...
use Renz\ModelBundle\Entity\Slider;
use Renz\AdminBundle\Form\SliderType;
...
class SliderController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ModelBundle:Slider')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('renz_admin_slider_index'));
        }
    ...
    private function createCreateForm(Slider $entity)
    {
        $form = $this->createForm(new SliderType(), $entity, array(
            'action' => $this->generateUrl('renz_admin_slider_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ModelBundle:Slider')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new SliderType(), $entity, array(
            'action' => $this->generateUrl('renz_admin_slider_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('renz_admin_slider_delete', array('id' => $id)))
            ->setMethod('DELETE')
